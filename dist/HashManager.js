...
export class HashManager extends BasicElement {
    ...
    static read(pathlike) {
        ...
        let value = pair === null || pair === void 0 ? void 0 : pair[1];
        if (value) {
            switch (type) {
                case 'number':
                    value = parseFloat(value);
    ...
    hashChange() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let handler of this.handlers) {
                let result = yield handler.handle(newHash, oldHash);
                if (result) {
                    if (Array.isArray(result)) {
                        yield this.swapContent(result[0], result[1]);
                    }
                    else {
                        yield this.swapContent(result, null);
                    }
                    break;
                }
            }
     ...
     */
    swapContent(body, direction = HashManager.DIRECTION.RIGHT) {
        return __awaiter(this, void 0, void 0, function* () {
...
HashManager.Handler = HashHandler;
