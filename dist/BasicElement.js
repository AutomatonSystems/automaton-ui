...
export class BasicElement extends HTMLElement {
    ...
    remove() {
        var _a;
        (_a = this.self.parentElement) === null || _a === void 0 ? void 0 : _a.removeChild(this.self);
        return this;
    }
    /**
        ...
        this.addEventListener('dragstart', (event) => {
            if (data == null) {
                if (this.dataset['drag'] == null) {
                    let id = "D_" + Math.floor(1000000 * Math.random()).toString(16);
    ...
    makeDroppable() {
        ...
        let handler = (event) => {
            ...
            for (let type of __classPrivateFieldGet(this, _BasicElement_dropTypeSet, "f")) {
    ...
    onDragOver(type, behaviour) {
        ...
        if (!this.droppable)
            this.makeDroppable();
        __classPrivateFieldGet(this, _BasicElement_dropTypeSet, "f").add(type);
...
_BasicElement_dropTypeSet = new WeakMap();
