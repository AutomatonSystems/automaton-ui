...
let uuid = 0;
class ManagedTable extends BasicElement{
...
export { Badge, BasicElement, Button, Cancel, Card, Code, Form, HashManager, Json, ManagedTable, Modal, Panel, Spacer, Spinner, Splash, Toast, Toggle, utils };
